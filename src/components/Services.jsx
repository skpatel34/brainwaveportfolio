...
import { brainwaveServices, brainwaveServicesIcons } from '../constants/iandex'
  ...
  return (
    <Section id="hoe-to-use">
      <div className="container">
        <Heading title="Generative AI made for creators." text="Brainwave unlocks the potential of AI-powred applications" />
        ...
        <div className="relative ">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem] ">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3 ">Brainwave unlocks the potential of-powred applications</p>
              <ul className="body-2">
            ...
            <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg-right-aut lg:bottom-8 lg:-translate-x-1/2" />
          </div>
